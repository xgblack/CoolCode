...
public class CoolResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public CoolBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new CoolCustomOpaqueTokenIntrospector(authorizationService);
	}
